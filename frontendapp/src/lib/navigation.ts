    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                capabilities: [
                    "FR-PAY-02..04 — contract picker, next-installment prefill, methods",
                    "FR-PAY-06-v2 — overpayment rejected unless allow_overpayment is on",
                    "FR-PAY-07-v2 — insert, balance and status transition in one transaction",
                    "FR-PAY-08-v2 — deleting is a void with a reason, never a hard delete",
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                capabilities: [
                    "FR-SET-01 — plan-month range, allow_overpayment, retention",
                    "FR-SET-01 — invoice letterhead identity block",
                    "FR-SET-01 — punctuality bands and loyalty tier thresholds",
                    "Seeded defaults already exist in the settings table",
                ],
            },
        ],
    },
